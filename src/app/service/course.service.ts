...
export class CourseService {
  ...
  filter() {
    let words = this.searchString.split(' ');
    let result: Course[] = [];
  ...
  initCourses() {
    ...
    this.allCourses.push(
      new Course(
        ...
        'Learn how to set up an InterSystems IRISÂ® data platform application to act as the back end of a web application. See how to expose your InterSystems IRIS application to REST so data can be accessed by external systems or users, and learn how to consume and produce JSON data with your application for easy data interchange.',
        'Intermediate',
        270,
    ...
    this.allCourses.push(
      new Course(
        ...
        'Connect InterSystems API Manager to your InterSystemsÂ® products to better monitor and control traffic to and from your web-based APIs. Learn what API Manager is, see how to set it up, and start managing your APIs.',
        'Introductory',
        165,
    ...
    this.allCourses.push(
      new Course(
        ...
        'Learn the structure and basic syntax of class definitions and how to develop an InterSystems IRISÂ® data platform class definition in Visual Studio Code. You will also learn how to define class members, such as properties, parameters, and methods.',
        'Introductory',
        60,
        'ISC1131, vs code',
        false
    ...
    this.allCourses.push(
      new Course(
        ...
        'See how you can use Embedded Python in InterSystems IRISÂ® data platform to access thousands of Python libraries and get low-latency access to data using a flexible combination of Python and InterSystems ObjectScript code.',
        'Introductory',
        10,
    ...
    this.allCourses.push(
      new Course(
        ...
        'Learn how to use globals, the data model native to InterSystems IRISÂ® data platform, to improve the efficiency and flexibility of your data storage.',
        'Introductory',
        10,
    ...
    this.allCourses.push(
      new Course(
        ...
        'Learn the basics of the security model in InterSystems IRIS data platform as well as the different aspects of security in InterSystems productsâ€”from the users in the system all the way through the assets they seek access to. This course will enable you to properly secure your applications and data.',
        'Introductory',
        60,
    ...
    this.allCourses.push(
      new Course(
        ...
        'Learn how to build a .NET application to connect to InterSystems IRISÂ® data platform using one or more APIs â€” ADO .NET, XEP, the Native API, and Entity Framework â€” by running the sample code provided.',
        'Introductory',
        10,
